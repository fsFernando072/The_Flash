                ...
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        res.json({
                            ...
                            fkFavorito: resultadoAutenticar[0].fkpersonagemfavorito
                        });
...
function favoritarPersonagem(req, res) {
    let idPersonagem = req.body.idPersonagem;
    let idUsuario = req.body.idUsuario;

    usuarioModel.favoritarPersonagem(idPersonagem, idUsuario)
        .then(
            function (resultado) {
                res.json(resultado);
            }
