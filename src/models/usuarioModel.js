...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT id, nome, email, caminhoImagem, senha, fkpersonagemfavorito FROM usuario WHERE email = '${email}' AND senha = '${senha}';
    `;
...
function cadastrar(nome, email, senha) {
    ...
    var instrucaoSql = `
        INSERT INTO usuario (nome, email, senha, caminhoImagem) VALUES ('${nome}', '${email}', '${senha}', 'icones/usuarioPadraoImg.png');
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
